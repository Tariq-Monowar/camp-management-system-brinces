...
const Organizerslist = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: "অংশগ্রহণ কৃত সংগঠক তালিকা",
      ...
      <div ref={componentRef} className="homePageContainer">
        <div style={{ marginBottom: "100px" }} className="regimentLest">
          <h1 className="regimentTitle">
            অংশগ্রহণ কৃত সংগঠক সংখ্যা:{" "}
            {convertToBanglaNumber(allDeligatet?.length)}
          </h1>
              ...
              allDeligatet.map((deleget, index) => {
                return (
                  <tr key={deleget.id}>
                    ...
                    <td>
                      {`৪৪.২৪.${convertToBanglaNumber(
                        String(deleget.delegatId).padStart(4, "0")
                      )}`}
                    </td>
                    <td>
                      <span
